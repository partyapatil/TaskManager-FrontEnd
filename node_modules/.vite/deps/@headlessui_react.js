...
import {
  require_react_dom
} from "./chunk-5HDGOSNM.js";
import {
  require_with_selector
} from "./chunk-S3L5CWVD.js";
import {
  require_react
} from "./chunk-JLBFSUBA.js";
import {
  __toESM
...
var O4 = class _O extends E5 {
  constructor(e8) {
    ...
    c13(this, "selectors", { activeDescendantId: (e9) => {
      ...
      if (n17 !== null)
        return e9.virtual ? (r20 = e9.options.find((u24) => !u24.dataRef.current.disabled && e9.dataRef.current.compare(u24.dataRef.current.value, e9.virtual.options[n17]))) == null ? void 0 : r20.id : (o21 = e9.options[n17]) == null ? void 0 : o21.id;
...
function Ae2(e8, t13) {
  ...
  let B4 = l11();
  n(() => {
    if (f24 && B4 && m12 === "visible" && r20.current === null)
...
var C10 = { [1](e8) {
  ...
  if (o21.focus === c9.Specific)
    return { ...t13, activeOptionIndex: e8.options.findIndex((r20) => r20.id === o21.id) };
