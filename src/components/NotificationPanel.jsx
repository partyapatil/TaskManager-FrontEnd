...
import { useGetNotificationQuery, useMarkNotiAsreadMutation } from "../redux/slices/UserApiSliceMutation";
...
const NotificationPanel = () => {
  ...
  const [selected, setSelected] = useState(null);
   ...
   const [markNotiAsread] = useMarkNotiAsreadMutation();

  const readHandler = async(id,type) => {
await markNotiAsread({type,id}).unwrap()
refetch()
  };
