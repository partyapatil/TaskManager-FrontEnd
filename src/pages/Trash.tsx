...
const [deleteRestoreTask] = useDeleteRestoreTaskMutation();
  ...
  const deleteClick = (id) => {
    // alert("Are you sure you want to delete this task? This action cannot be undone.");
    setType("delete");
    setSelected(id);
    setOpenDialog(true);
  };
...
//     if (type === "deleteAll") {
//       await deleteRestoreTask({ id: "", actionType: "deleteAll" });
//     } else if (type === "restoreAll") {
//       await deleteRestoreTask({ id: "", actionType: "restoreAll" });
//     } else {
//       await deleteRestoreTask({ id: selected, actionType: type });
//     }
//     setOpenDialog(false);
